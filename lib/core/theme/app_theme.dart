...
abstract class AppTheme {
  ...
  static ThemeData get darkTheme {
    final colorScheme = ColorScheme(
      ...
      primaryContainer: AppColors.primaryDarkTheme.withValues(alpha: 0.25),
      onPrimaryContainer: AppColors.primaryDarkThemeLight,
      secondary: AppColors.secondaryDarkTheme,
      onSecondary: AppColors.backgroundDark,
      secondaryContainer: AppColors.secondaryDarkTheme.withValues(alpha: 0.2),
      onSecondaryContainer: AppColors.secondaryDarkThemeLight,
      tertiary: AppColors.accentDarkTheme,
      onTertiary: AppColors.backgroundDark,
      tertiaryContainer: AppColors.accentDarkTheme.withValues(alpha: 0.2),
      onTertiaryContainer: AppColors.accentDarkThemeLight,
      error: AppColors.error,
      onError: Colors.white,
